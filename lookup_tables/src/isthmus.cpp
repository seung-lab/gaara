// This file generates isthmus.bin which is a bit packed file
// that can answer "is this point an isthmus?"

// Palágyi, referencing Malandain and Bertrand noted that
// an isthmus point (p) in the center of a 3x3x3 binary space containing 
// foreground (1) and background (0) must satisfy:
//
// 1. The 26-connected foreground set without p must have 
//    2 or more connected components.
//
